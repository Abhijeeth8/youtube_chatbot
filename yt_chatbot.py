...
def summarize_transcript(yt_transcript):
    ...
    summary = llm.invoke("Summarize the following transcript briefly in 20 points and always satart by saying the video discusses about and never use the word transcript. Always respond in Markdown:\n\n" + yt_transcript)
...
def start_chatbot(retriever, question, conversation):
